...
# The most reliable way to show the app's own code in a deployed Streamlit app
# (like on Snowflake) is to embed it directly as a multi-line string.
# Copy the entire content of your 'app.py' file and paste it between the triple quotes below.
app_code = """
import streamlit as st
import pandas as pd
import plotly.express as px
